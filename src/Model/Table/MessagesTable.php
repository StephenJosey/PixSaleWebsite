 ...
 * Messages Model
 *
 * @property \App\Model\Table\MediaItemsTable|\Cake\ORM\Association\BelongsTo $MediaItems
 *
...
class MessagesTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['media_items_id'], 'MediaItems'));
